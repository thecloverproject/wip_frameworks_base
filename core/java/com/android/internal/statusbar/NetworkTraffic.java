...
public class NetworkTraffic extends TextView {
    ...
    private CloverStatusBarItem.Manager mManager;
    ...
    private final CloverStatusBarItem.DarkReceiver mDarkReceiver =
            new CloverStatusBarItem.DarkReceiver() {
    ...
    private final CloverStatusBarItem.VisibilityReceiver mVisibilityReceiver =
            new CloverStatusBarItem.VisibilityReceiver() {
    ...
    protected void onAttachedToWindow() {
        ...
        mManager = CloverStatusBarItem.findManager(this);
        if (mManager != null) {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.Secure.getUriFor(
                    ...
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.Secure.getUriFor(
                    Settings.Secure.NETWORK_TRAFFIC_HIDE_ARROWS),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.Secure.getUriFor(
    ...
    private void updateSettings() {
        ...
        mHideArrows = Settings.Secure.getInt(resolver,
                Settings.Secure.NETWORK_TRAFFIC_HIDE_ARROWS, 0) == 1;
