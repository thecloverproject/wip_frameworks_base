...
import com.android.internal.statusbar.CloverStatusBarItem;

import java.util.ArrayList;

public class CloverStatusBarItemHolder extends RelativeLayout
        implements CloverStatusBarItem.Manager {
    private static final String TAG = "CloverStatusBarItemHolder";

    private ArrayList<CloverStatusBarItem.DarkReceiver> mDarkReceivers =
            new ArrayList<CloverStatusBarItem.DarkReceiver>();
    private ArrayList<CloverStatusBarItem.VisibilityReceiver> mVisibilityReceivers =
            new ArrayList<CloverStatusBarItem.VisibilityReceiver>();
    ...
    public CloverStatusBarItemHolder(Context context) {
        this(context, null);
    }

    public CloverStatusBarItemHolder(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CloverStatusBarItemHolder(Context context, AttributeSet attrs, int defStyle) {
    ...
    private DarkReceiver mDarkReceiver = new DarkReceiver() {
        ...
        public void onDarkChanged(ArrayList<Rect> areas, float darkIntensity, int tint) {
            ...
            mLastTint = tint;
            for (CloverStatusBarItem.DarkReceiver r : mDarkReceivers) {
    ...
    private void updateVisibilityReceivers(boolean isVisible) {
        ...
        for (CloverStatusBarItem.VisibilityReceiver r : mVisibilityReceivers) {
            r.onVisibilityChanged(mItemHolderIsVisible);
        }
    }

    // CloverStatusBarItem.Manager methods

    public void addDarkReceiver(CloverStatusBarItem.DarkReceiver darkReceiver) {
    ...
    public void addVisibilityReceiver(CloverStatusBarItem.VisibilityReceiver visibilityReceiver) {
        mVisibilityReceivers.add(visibilityReceiver);
        visibilityReceiver.onVisibilityChanged(mItemHolderIsVisible);
    }

    public void removeDarkReceiver(CloverStatusBarItem.DarkReceiver darkReceiver) {
        mDarkReceivers.remove(darkReceiver);
    }

    public void removeVisibilityReceiver(
            CloverStatusBarItem.VisibilityReceiver visibilityReceiver) {
